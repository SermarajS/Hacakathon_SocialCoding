...
<html lang="en">
   <head>
      ...
      <script type="text/javascript" src="{/SocialCoding/src/main/webapp/index.js}"></script>
   </head>
   <style>
      * {
      margin: 0;
      ...
      <form>
         ...
         <header>
            <div class="logosec">
               ...
               <div class="logo">Social Coding SA</div>
            </div>
            <div class="searchbar">
               ...
               <nav class="nav">
                  <div class="nav-upper-options">
                     <div class="nav-option" id="DashboardIcon">
                        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210182148/Untitled-design-(29).png" class="nav-img" alt="dashboard" onclick="document.getElementById('DashboardDisplay').style.display='block';"  />
                        <h3>Dashboard</h3>
                     </div>
                     <div class="option2 nav-option">
                        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210183322/9.png" class="nav-img" alt="articles" onclick="javascript:window.location='/SocialCoding/Modules.jsp';"/>
                        <h3>Modules</h3>
                     </div>
                     ...
                     <div class="nav-option option4">
                        <img src="https://icon-library.com/images/calendar-icon-png/calendar-icon-png-2.jpg" class="nav-img" alt="Calendar" id="CalendarViewID" onclick="javascript:window.location='/SocialCoding/calendar.jsp';"/>
                        <h3>Calendar</h3>
                     </div>
               ...
               <div  id="DashboardDisplay">
                  <div class="container" style="text-align:center">
                     ...
                     <select name="Modules" id="Modules">
                        ...
                        <option value="Lego Robotics">Lego Robotics</option>
                        <option value="Introduction to 4IR">Introduction to 4IR</option>
                        <option value="AI and Machine Learning">AI and ML</option>
